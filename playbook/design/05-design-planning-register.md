...
| FI-DSN-STD-010 | Collection Membership and Eligibility Standard | STD | CLS-ASG | — | Not Applicable | Drafted, Pending Architecture Validation | FI-DSN-GOV-001; `playbook/design/volume-05-signature-collections/01-signature-collections-architecture.md`; FI-DSN-PRN-001; FI-DSN-STD-001; FI-DSN-STD-002; FI-DSN-STD-003; FI-DSN-STD-004; FI-DSN-STD-005; FI-DSN-STD-006; FI-DSN-STD-007; FI-DSN-STD-008; FI-DSN-STD-009; FI-DSN-GOV-002; FI-DSN-GOV-004; applicable frozen `FI-MFG-*` | FI-DSN-GOV-001 | None Required | Yes — collection membership and eligibility governance is company judgment | F.I. Forgot | — | 0.2 Architecture Draft | — | Primary Volume: VOL-05. Domain 1 — Collection Membership and Eligibility. Volume governance: `01-signature-collections-architecture.md` Version 1.0 Frozen. Standard architecture: `playbook/design/volume-05-signature-collections/02-collection-membership-and-eligibility-standard.md` Version 0.2 Architecture Draft. Does not own visual permission, contextual selection, personalization, metadata field semantics, provenance schemas, manufacturing execution, storage state, or runtime decisions |
| FI-DSN-STD-011 | Collection Lifecycle and Consistency Standard | STD | CLS-ASG | — | Not Applicable | Reserved, Not Drafted | FI-DSN-GOV-001; `playbook/design/volume-05-signature-collections/01-signature-collections-architecture.md`; FI-DSN-PRN-001; FI-DSN-STD-001; FI-DSN-STD-002; FI-DSN-STD-003; FI-DSN-STD-004; FI-DSN-STD-005; FI-DSN-STD-006; FI-DSN-STD-007; FI-DSN-STD-008; FI-DSN-STD-009; FI-DSN-GOV-002; FI-DSN-GOV-004; applicable frozen `FI-MFG-*`; `FI-DSN-STD-010` | FI-DSN-GOV-001 | None Required | Yes — collection lifecycle and consistency governance is company judgment | F.I. Forgot | — | — | — | Primary Volume: VOL-05. Domain 2 — Collection Lifecycle and Consistency. Volume governance: `01-signature-collections-architecture.md` Version 1.0 Frozen. Sequenced after `FI-DSN-STD-010` per architecture Section 12; Domain 2 consumes frozen Domain 1 membership decisions per Section 9.3.1. Does not own permanent membership eligibility, visual identity permission, contextual selection, manufacturing scheduling, production execution, customer fulfillment, delivery timing, DAM operations, or runtime orchestration |
