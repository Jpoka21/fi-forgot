...
The following table is the authoritative planning inventory of Design Library planning artifacts. It records frozen meta-governance and Layer B standards for Volumes 02–05, and Volume 06 Layer B reserved identifiers (`FI-DSN-STD-012` through `FI-DSN-STD-015`) at **Reserved, Not Drafted**. Identifier reservation does not authorize drafting, QUE admission, or Layer B standard file creation.
