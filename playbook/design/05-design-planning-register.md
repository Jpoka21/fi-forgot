...
| FI-DSN-STD-008 | Occasion and Emotional Context Standard | STD | CLS-OEC | — | Not Applicable | Drafted, Pending Freeze | FI-DSN-GOV-001; `playbook/design/volume-04-artwork-intelligence/01-artwork-intelligence-architecture.md`; FI-DSN-PRN-001; FI-DSN-STD-001; FI-DSN-STD-002; FI-DSN-STD-003; FI-DSN-STD-004; FI-DSN-STD-005; FI-DSN-STD-006; FI-DSN-GOV-004; applicable frozen `FI-MFG-*`; `FI-DSN-STD-007` | FI-DSN-GOV-001 | None Required | Yes — occasion and emotional context governance is company judgment | F.I. Forgot | — | 0.1 | July 24, 2026 | Primary Volume: VOL-04. Domain 1 — Context Semantics. Volume governance: `01-artwork-intelligence-architecture.md` Version 1.0 Frozen. Draft standard: `03-occasion-and-emotional-context-standard.md` Version 0.1 Draft |
