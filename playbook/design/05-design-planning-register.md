...
| FI-DSN-STD-007 | Brain Visual Selection Standard | STD | CLS-BVS | — | Not Applicable | Reserved, Not Drafted | FI-DSN-GOV-001; `playbook/design/volume-04-artwork-intelligence/01-artwork-intelligence-architecture.md`; FI-DSN-PRN-001; FI-DSN-STD-001; FI-DSN-STD-002; FI-DSN-STD-003; FI-DSN-STD-004; FI-DSN-STD-005; FI-DSN-STD-006; FI-DSN-GOV-004; applicable frozen `FI-MFG-*` | FI-DSN-GOV-001 | None Required | Yes — brain visual selection boundaries are company judgment | F.I. Forgot | OQ-DSN-007 | — | — | Primary Volume: VOL-04. Domain 3 — Authorized Selection. Architecture: `01-artwork-intelligence-architecture.md` Version 1.0 Frozen (Volume Governance — not a Layer B row). First Layer B standard — eligible for governed drafting preparation |
| FI-DSN-STD-008 | Occasion and Emotional Context Standard | STD | CLS-OEC | — | Not Applicable | Reserved, Not Drafted | FI-DSN-GOV-001; `playbook/design/volume-04-artwork-intelligence/01-artwork-intelligence-architecture.md`; FI-DSN-PRN-001; FI-DSN-STD-001; FI-DSN-STD-002; FI-DSN-STD-003; FI-DSN-STD-004; FI-DSN-STD-005; FI-DSN-STD-006; FI-DSN-GOV-004; applicable frozen `FI-MFG-*` | FI-DSN-GOV-001 | None Required | Yes — occasion and emotional context governance is company judgment | F.I. Forgot | — | — | — | Primary Volume: VOL-04. Domain 1 — Context Semantics. Upstream architecture: frozen Volume 04 Artwork Intelligence Architecture (Version 1.0). Sequenced after `FI-DSN-STD-007` per architecture Section 11 |
| FI-DSN-STD-009 | Personalization Policy Standard | STD | CLS-PER | — | Not Applicable | Reserved, Not Drafted | FI-DSN-GOV-001; `playbook/design/volume-04-artwork-intelligence/01-artwork-intelligence-architecture.md`; FI-DSN-PRN-001; FI-DSN-STD-001; FI-DSN-STD-002; FI-DSN-STD-003; FI-DSN-STD-004; FI-DSN-STD-005; FI-DSN-STD-006; FI-DSN-GOV-002; FI-DSN-GOV-004; applicable frozen `FI-MFG-*` | FI-DSN-GOV-001 | None Required | Yes — personalization policy is company judgment | F.I. Forgot | OQ-DSN-003 | — | — | Primary Volume: VOL-04. Domain 2 — Personalization Policy. Upstream architecture: frozen Volume 04 Artwork Intelligence Architecture (Version 1.0). Sequenced after `FI-DSN-STD-008` per architecture Section 11 |
