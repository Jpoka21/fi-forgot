...
**Planning posture:** Sprint V06-D22.1 — G9 Tranche 2 normative requirements drafted (`FI-DSN-STD-014-R68`–`R71`; Section 21.9.5). G9 Tranche 1 **accepted** (`FI-DSN-STD-014-R64`–`R67`; V06-D21.3). G9 normative requirement drafting **authorized** (Sprint V06-D21.1). G9 planning architecture **accepted** (Sprint V06-D20.2; Section 20.21). G8 normative requirements **drafted and independently accepted** (`FI-DSN-STD-014-R52`–`R63`; Section 21.8; Sprint V06-D19.6). G1 through G8 drafted (`FI-DSN-STD-014-R01`–`R63` continuous). G9 normative body **partial**. G10–G11 normative requirement drafting remains **unauthorized**.
...
Normative requirement drafting for `FI-DSN-STD-014` remains **partial**. G8 normative requirements **`FI-DSN-STD-014-R52`–`R63`** are **drafted and independently accepted** (Sprints V06-D19.1, V06-D19.3, V06-D19.5; acceptance V06-D19.6; Section 21.8). G9 planning architecture is **accepted** (Sprint V06-D20.2; Section 20.21). G9 normative requirement drafting is **authorized** (Sprint V06-D21.1). G9 Tranche 1 normative requirements **`FI-DSN-STD-014-R64`–`R67`** are **accepted** (V06-D21.3; Section 21.9 Tranche 1). G9 Tranche 2 normative requirements **`FI-DSN-STD-014-R68`–`R71`** are **drafted** (Sprint V06-D22.1; Section 21.9.5). G9 normative body remains **partial**. G10–G11 normative requirement drafting remains **unauthorized**. G1 through G7 status preserved per prior sprints. Independent requirement planning review **passed** (V06-D5.2; V06-D5.3 corrective completed; V06-D5.4 adoption). Tranche 1 preparation review **passed** (V06-D6.2).
...
| **Preparation status** | **Complete** (Sprint V06-D20.1); G9 planning **accepted** (Sprint V06-D20.2); G9 normative drafting **authorized** (Sprint V06-D21.1); G9 Tranche 1 **accepted** (`FI-DSN-STD-014-R64`–`R67`; V06-D21.3); G9 Tranche 2 **drafted** (`FI-DSN-STD-014-R68`–`R71`; Sprint V06-D22.1); G9 **partial**; G10–G11 normative drafting **unauthorized** |
...
**Drafting posture:** Sprint V06-D22.1 — normative requirements drafted for planning groups **G1** through **G9** Tranche 2 (`FI-DSN-STD-014-R01` through `FI-DSN-STD-014-R71` continuous through `R71`; G6 committed `c8eeb2913ddf0170703518757ba36b3c72ea30ac`; G7 planning adopted `cebf454`). G8 Section 21.8 (`FI-DSN-STD-014-R52`–`R63`) is **complete** at Layer B for **Retention** and **Invalidated** posture. G9 Section 21.9 Tranche 1 (`FI-DSN-STD-014-R64`–`R67`) is **accepted** (V06-D21.3). G9 Section 21.9 Tranche 2 (`FI-DSN-STD-014-R68`–`R71`) establishes SSAC, PSIM, PIIM, and forward authority transition; G9 normative body remains **partial**. Groups **G10** through **G11** are **not drafted** and remain **unauthorized**. This partial draft does not claim approval, freeze, binding authority, or effective status beyond draft governance posture.
...
Post-approval **Superseded** posture is governed by **RIVP** peer-posture vocabulary and **PVTA** ST supersession trigger families (Section 20.21). G9 Tranche 1 normative requirements (`FI-DSN-STD-014-R64`–`R67`) establish **Superseded** posture definition, separate supersession acts, ST trigger-family architecture, and predecessor–successor historical preservation baseline. G9 Tranche 2 normative requirements (`FI-DSN-STD-014-R68`–`R71`) establish SSAC supersession authority classes, full PSIM identity and lineage, PIIM posture interaction, and forward authority transition. G9 completion boundary remains assigned to a later G9 tranche. G9 normative drafting is **partial** at `FI-DSN-STD-014-R71`. Brain interaction detail and Governed Handoff are assigned to G10–G11.

**Undrafted groups:** G10–G11 — **not drafted**. **G9 Tranche 3** — **not drafted**.
