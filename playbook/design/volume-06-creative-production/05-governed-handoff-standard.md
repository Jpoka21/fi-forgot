...
| **3 — Recall, re-entry, completion** | HOF-G6 (U1); HOF-G5 HERCM re-entry; HOF-G8 completion; HOF-G9 completion | `FI-DSN-STD-015-R70`–`R83` (HOF-G6-U1) | HOF-G6-U1 **committed** (Sprint V06-D43.14; commit `3720c6531da3e704af93e03b3b19b72c7d7c9973`); post-commit **verified** (Sprint V06-D43.15; **Verification PASS** **accepted**); HOF-G6-U2 through U4, HERCM, HOF-G8 completion, and HOF-G9 completion normative drafting **not authorized**; **`R84`** next assignable — **undrafted** |
