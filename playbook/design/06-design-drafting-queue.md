...
|---------------------|-------------------------------|-------------|-----------------|-------|---------------|-----------|-------|
| FI-DSN-STD-014 | Architecture Draft | In progress | 20 | F.I. Forgot | July 29, 2026 | — | Drafting sequence 3 of 4. Direct predecessor: `FI-DSN-STD-013` (Version 1.0 Frozen). `CLS-CPR` Primary Classification; `CLS-MFI` Secondary Classification only. Design-Time Feasibility remains a Review dimension; applicable `FI-MFG-*` artifacts remain Compliance Boundaries only. `OQ-V06-006`; `OQ-STD-014-001`–`005`; `PD-STD-014-001`–`005`, `007` (`PD-STD-014-006` resolved). Sprint V06-D6.1 — `PD-STD-014-006` resolved; Tranche 1 preparation complete; Tranche 1 normative drafting next separate gate; normative requirement drafting unauthorized; EO 20 **In progress**; not approved; not frozen; not binding; `FI-DSN-STD-015` remains **Queued**; Product Sprint 004 unauthorized |
