...
|---------------------|-------------------------------|-------------|-----------------|-------|---------------|-----------|-------|
| FI-DSN-STD-014 | Architecture Draft | In progress | 20 | F.I. Forgot | July 29, 2026 | — | Drafting sequence 3 of 4. Direct predecessor: `FI-DSN-STD-013` (Version 1.0 Frozen). `CLS-CPR` Primary Classification; `CLS-MFI` Secondary Classification only. Design-Time Feasibility remains a Review dimension; applicable `FI-MFG-*` artifacts remain Compliance Boundaries only. `OQ-STD-014-003`; `OQ-STD-014-005`; `OQ-STD-014-007` (`OQ-STD-014-004` closed); `PD-STD-014-004`, `007` (`PD-STD-014-001`, `PD-STD-014-002`, `PD-STD-014-003`, baseline `PD-STD-014-005`, and `PD-STD-014-006` resolved). Sprint V06-D13.1A — MAGAC establishment versus activation clarified; Approval and GPRA baseline clarified; `OQ-STD-014-004` closed; `OQ-STD-014-007` opened for G9; MAGAC, EGWG, and TOC-PA preserved; G6 drafting preparation complete; G5 committed (`FI-DSN-STD-014-R27`–`R33`); G6 normative drafting next separate gate; G6–G11 normative requirement drafting unauthorized; EO 20 **In progress**; not approved; not frozen; not binding; `FI-DSN-STD-015` remains **Queued**; Product Sprint 004 unauthorized |
