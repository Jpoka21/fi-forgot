...
|---------------------|-------------------------------|-------------|-----------------|-------|---------------|-----------|-------|
| FI-DSN-STD-013 | Architecture Draft | In progress | 19 | F.I. Forgot | July 29, 2026 | — | Sprint V06-D2.7 — Part 2 normative requirement draft complete (`FI-DSN-STD-013-R17`–`R35`; G3, G4, G5, G6); drafted groups G1, G8, G2, G3, G4, G5, G6 (`R01`–`R35`); G7, G9, G10, and Brain Interaction undrafted; full-body independent requirement review remains unauthorized; EO 19 remains **In progress**; no exit date; predecessor `FI-DSN-STD-012` Version 1.0 Frozen satisfied; `OQ-DSN-003` inherited; `OQ-STD-013-001` resolved; `OQ-STD-013-002` resolved; `OQ-STD-013-003` partially resolved; `FI-DSN-STD-014` through `FI-DSN-STD-015` remain **Queued** |
