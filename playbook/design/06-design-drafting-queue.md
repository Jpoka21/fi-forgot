...
|---------------------|-------------------------------|-------------|-----------------|-------|---------------|-----------|-------|
| FI-DSN-STD-013 | Architecture Draft | In progress | 19 | F.I. Forgot | July 29, 2026 | — | Sprint V06-D2.2 — Version 0.1 Architecture Draft created at `03-artifact-realization-governance-standard.md`; locked governing question embedded; normative requirements not drafted; architecture validation pending; predecessor `FI-DSN-STD-012` Version 1.0 Frozen satisfied; `OQ-DSN-003` inherited; `OQ-STD-013-001`–`005` owned; `FI-DSN-STD-014` through `FI-DSN-STD-015` remain **Queued** |
