...
|---------------------|-------------------------------|-------------|-----------------|-------|---------------|-----------|-------|
| FI-DSN-STD-013 | Drafted, Pending Freeze | In progress | 19 | F.I. Forgot | July 29, 2026 | — | Sprint V06-D2.9 — Part 3 normative requirement draft complete (`FI-DSN-STD-013-R36`–`R51`; G7, G9, G10, Brain Interaction); full body `R01`–`R51`; all planning groups drafted; independent full constitutional review pending; EO 19 remains **In progress**; no exit date; predecessor `FI-DSN-STD-012` Version 1.0 Frozen satisfied; `OQ-DSN-003` inherited; `OQ-STD-013-001` through `005` resolved at constitutional layer; `FI-DSN-STD-014` through `FI-DSN-STD-015` remain **Queued** |
| FI-DSN-STD-014 | Reserved, Not Drafted | Queued | 20 | F.I. Forgot | July 29, 2026 | — | Drafting sequence 3 of 4. Direct predecessor: `FI-DSN-STD-013` (Drafted, Pending Freeze, not frozen). `CLS-CPR` Primary Classification; `CLS-MFI` Secondary Classification only. Design-Time Feasibility remains a Review dimension; applicable `FI-MFG-*` artifacts remain Compliance Boundaries only. `OQ-V06-006`. Queue admission only — drafting not authorized; no standard file exists |
