/**
 * Established Sprint 9B.2 attempt 3 targeted panel test command.
 * Runs the full writing-contract unit suite + prior harness self-checks + this panel harness.
 *
 * Usage:
...
results.push(
  run("pilot-9B.2-v1-self-check", "node", [
    "playbook/writing-quality/pilot-9B.2-v1/run-pilot.mjs",
    "--self-check",
  ]),
);
results.push(
  run("pilot-9B.2-v2-panel-self-check", "node", [
    "playbook/writing-quality/pilot-9B.2-v2-panel/run-pilot.mjs",
    "--self-check",
  ]),
);
results.push(
  run("pilot-9B.2-v3-panel-self-check", "node", [
    "playbook/writing-quality/pilot-9B.2-v3-panel/run-pilot.mjs",
    "--self-check",
  ]),
);
