/**
 * Established Sprint 9B.2 evaluation test command.
 * Runs the full writing-contract unit suite + prior harness self-checks + this harness.
 *
 * Usage:
 *   node playbook/writing-quality/pilot-9B.2-v1/run-established-tests.mjs
 *
 * Expected: 316 unit assertions + harness self-checks, all exit 0.
 */
...
console.log(`Expected unit total: 316 passed, 0 failed`);
if (unitPassed !== 316 || unitFailed !== 0) {
  console.log("WARNING: unit total differs from established 316.");
  hardFail = true;
}
