...
const CARD_DESIGNS: CardDesign[] = [
  ...
  {
    title: "Medieval Hedgehog",
    category: "birthday",
    subcategory: "medieval_hedgehog",
    prompt: "A premium greeting card front. A delightfully round hedgehog depicted in the style of an illuminated medieval manuscript — surrounded by ornate gold-leaf borders with intertwining vines, tiny flowers, and heraldic flourishes. The hedgehog sits in regal repose at the center, quills rendered with fine calligraphic detail. Rich vermillion, cobalt blue, burnished gold, and cream vellum tones. Slightly aged, as if lifted from a treasured illuminated book. No text, no people, no numbers. Portrait orientation. Print-quality fine art.",
    tags: ["birthday", "hedgehog", "medieval", "illuminated", "gold", "whimsical", "funny"],
    style: "whimsical illustration",
    tone: "playful",
    primaryColor: "gold",
    seasonal: false,
...

  {
    title: "Fancy Pig",
    category: "humor",
    subcategory: "fancy_pig",
    prompt: "A premium greeting card front. A rotund, elegant pig seated at a perfectly appointed formal tea table — fine bone china, a silver tiered cake stand, and a delicate floral centerpiece arranged around it. The pig's expression is one of complete refinement and contentment. Soft afternoon light through lace curtains. Ivory, blush rose, sage, and warm cream. Painted in the style of a charming 19th-century English country house illustration. No text, no people, no numbers. Portrait orientation. Print-quality fine art.",
    tags: ["humor", "pig", "tea", "formal", "elegant", "blush", "funny"],
    style: "elegant illustration",
    tone: "playful",
    primaryColor: "blush",
    seasonal: false,
...

  {
    ...
    category: "humor",
    subcategory: "distinguished_duck",
    prompt: "A premium greeting card front. A mallard duck posed in the precise manner of a Georgian-era gentleman's portrait — head turned at a three-quarter angle, expression composed and self-important, against a subtly rendered neutral studio background with a hint of silk drapery. The duck's iridescent green head painted with extravagant Old Master detail. Deep forest green, burnt sienna, and warm ivory. Painterly oil brushwork with theatrical soft lighting. No text, no people, no numbers. Portrait orientation. Print-quality fine art.",
    tags: ["humor", "duck", "gentleman", "portrait", "green", "funny", "aristocratic"],
    style: "oil painting parody",
    tone: "playful",
    primaryColor: "green",
    seasonal: false,
  ...
  {
    title: "Sophisticated Llama",
    category: "humor",
    subcategory: "sophisticated_llama",
    prompt: "A premium greeting card front. A long-necked llama depicted as the picture of aristocratic leisure — standing in a manicured English countryside estate garden, rolling hills and topiary hedges of a grand manor visible behind it. The llama's expression is effortlessly superior. Soft overcast light, painterly and impressionistic. Sage green, soft lavender, warm cream, and muted gold. Loose, confident brushwork in the style of a prestigious country-life painting. No text, no people, no numbers. Portrait orientation. Print-quality fine art.",
    tags: ["humor", "llama", "countryside", "luxury", "sage", "funny", "sophisticated"],
    style: "luxury painting",
    tone: "sophisticated",
    primaryColor: "sage",
    seasonal: false,
