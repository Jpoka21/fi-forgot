...
const CARD_DESIGNS: CardDesign[] = [
...

  {
    ...
    prompt: "A premium greeting card front. A cheerful brown bear seated in a sun-dappled woodland clearing, surrounded by a gorgeous natural abundance — clusters of ripe woodland berries, bright wildflowers, and golden autumn leaves arranged around a mossy log. Tall oaks frame the scene, warm dappled light filtering through the canopy. The bear's expression radiates warm, uncomplicated joy. Warm honey, forest green, soft rose, and golden light. Whimsical watercolor illustration with loose, luminous brushwork. No text, no people, no numbers. Portrait orientation. Print-quality fine art.",
...

  {
    ...
    tags: ["encouragement", "tortoise", "journey", "meadow", "sage", "hopeful", "nature"],
    style: "watercolor",
    tone: "hopeful",
    primaryColor: "sage",
    seasonal: false,
