...
export const AI_PROMPT_SURFACES: AiPromptSurface[] = [
  ...
  },
  {
    ...
    method: "POST",
    description: "Generates one customer-facing card draft during onboarding and /try flows.",
    contextFields: ["recipient profile", "occasion", "tone", "memories", "primaryOccasionContext", "signOff"],
    preservationNote: "Used by onboarding and /try — Sprint 8F one-card contract.",
  },
  {
    id: "v2-refine-card",
    ...
    method: "POST",
    description: "Refines an existing draft with user guidance under factual grounding (Sprint 8E).",
    contextFields: ["draft text", "refinement instruction", "groundingContext"],
    preservationNote: "Refinement behavior is server-owned; must not invent personal facts.",
  },
  {
