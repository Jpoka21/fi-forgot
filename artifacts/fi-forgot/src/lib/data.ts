...
export interface BriefingQuestion {
  ...
  hint?: string;
  optional?: boolean;
  showIf?: { key: string; value: string };  // show only when answers[key] === value
}
...
export const EVENT_QUESTIONS: Record<string, BriefingQuestion[]> = {
  "Birthday": [
    ...
    },
    {
      ...
      type: "text",
      optional: true,
      showIf: { key: "milestone", value: "Yes" },
    },
    {
      key: "this_year",
      question: "What did she go through or accomplish this past year?",
  ...
  "Anniversary": [
    ...
    },
    {
      ...
      type: "text",
      optional: true,
      showIf: { key: "milestone_anniversary", value: "Yes" },
    },
    {
      key: "best_moment",
  ...
  "Valentine's Day": [
    {
      key: "what_you_love",
      question: "What's something you love about her that you don't say out loud enough?",
  ...
  "Christmas": [
    {
      key: "tradition",
      question: "Is there a holiday tradition, memory, or feeling that should be in the card?",
      placeholder: "She always bakes the same thing / We always do... / The thing the kids look forward to every year / That feeling when...",
      type: "textarea",
    },
    {
      key: "this_year_ref",
      question: "Anything specific from this year we should reference?",
      placeholder: "A big moment, something she powered through, something worth acknowledging...",
      type: "textarea",
      optional: true,
    },
  ],
  ...
  "Thanksgiving": [
    ...
    {
      key: "she_brings",
      question: "What does she bring to your life or family that doesn't get said enough?",
      placeholder: "She's the one who always... / The house would feel different without... / She makes every holiday feel like...",
      type: "textarea",
      optional: true,
    },
  ],
