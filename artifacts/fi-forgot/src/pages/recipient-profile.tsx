...
const schema = z.object({
  ...
  previewDays: z.union([z.literal(10), z.literal(14), z.literal(21), z.literal(30)]),
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: existing
      ? {
          ...
          previewDays: (existing.previewDays ?? 14) as 10 | 14 | 21 | 30,
